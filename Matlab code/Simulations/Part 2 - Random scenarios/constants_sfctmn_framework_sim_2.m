...
INPUT_FIELD_BSS_COLOR = 16;                     % Index of bss color field in the input file
INPUT_FIELD_SRG = 17;                           % Index of the SRG
INPUT_FIELD_OBSS_PD = 18;                       % Index of the OBSS_PD
INPUT_FIELD_OBSS_PD_MIN = 19;                   % Index of the OBSS_PD_MIN
INPUT_FIELD_OBSS_PD_MAX = 20;                   % Index of the OBSS_PD_MAX
INPUT_FIELD_SRG_OBSS_PD = 21;                   % Index of the SRG OBSS_PD
INPUT_FIELD_NON_SRG_OBSS_PD = 22;               % Index of the non-SRG OBSS_PD
INPUT_FIELD_TX_PWR_REF = 23;                    % Index of the TX PWR REF
...
STATE_DEFAULT = 1;
STATE_SR_ACTIVATED = 2;
STATE_SRG_ACTIVATED = 3;
STATE_NONSRG_ACTIVATED = 4;
