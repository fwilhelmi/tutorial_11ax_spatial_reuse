...
% CHANNEL OCCUPANCY
data1 = [default_time_channel_wlan_a{3,1} max_time_channel_wlan_a{3,1}; ...
   default_time_channel_wlan_a{3,2} max_time_channel_wlan_a{3,2}; ...
   default_time_channel_wlan_a{3,3} max_time_channel_wlan_a{3,3}];

data2 = [default_time_channel_average{3,1} max_time_channel_average{3,1}; ...
    default_time_channel_average{3,2} max_time_channel_average{3,2}; ...
    default_time_channel_average{3,3} max_time_channel_average{3,3}];
...
% THROUGHPUT
data1 = [default_tpt_wlan_a{3,1} max_tpt_wlan_a{3,1}; ...
   default_tpt_wlan_a{3,2} max_tpt_wlan_a{3,2}; ...
   default_tpt_wlan_a{3,3} max_tpt_wlan_a{3,3}];

data2 = [default_tpt_average{3,1} max_tpt_average{3,1}; ...
    default_tpt_average{3,2} max_tpt_average{3,2}; ...
