...
\begin{document}
	...
	\begin{figure*}[ht!]
		\centering
		\subfigure[Scenario]{\label{fig:11ax_bss_coloring_a}\includegraphics[width=0.3\columnwidth]{fig_2a}}
		\hspace{1cm}
		\subfigure[Packets exchange]{\label{fig:11ax_bss_coloring_b}\includegraphics[width=0.3\columnwidth]{fig_4b}}
	...
	\begin{figure*}[ht!]
		\centering
		\subfigure[Scenario]{\label{fig:fig_5_a}\includegraphics[width=0.3\columnwidth]{fig_5_a}}
		\hspace{1cm}
		\subfigure[Packets exchange]{\label{fig:fig_5_b}\includegraphics[width=0.5\columnwidth]{fig_5_b}}
	...
	\begin{figure}[ht!]
		\centering
		\epsfig{file=fig_6.pdf, width=6cm}
	...
	\begin{table}[ht!]
		...
		\end{tabular}
		\caption{Spatial Reuse subfield encoding for Trigger and HE TB PPDU frames (\citealp{tgax2019draft}).}
	...
	\begin{figure*}[ht!]
		\centering
		\subfigure[Scenario]{\label{fig:fig_13a}\includegraphics[width=0.33\columnwidth]{fig_13a}}
		\hspace{1cm}
		\subfigure[Packets exchange]{\label{fig:fig_13b}\includegraphics[width=0.4\columnwidth]{fig_13b}}
		\caption{Example of the SRP-based SR operation.}
		\label{fig:fig_13}
	\end{figure*}
%	\begin{figure}[ht!]
%		\centering
%		\includegraphics[width=0.3\columnwidth]{fig_13a}
...
%	\begin{figure}[ht!]
%		\centering
%		\includegraphics[width=0.5\columnwidth]{fig_13b}
...
%	\end{figure}
	...
	\begin{figure}[h!]
		\centering
		% Situation 1
		\subfigure[Sensing area]{\label{fig:cs_toy_scenario_1a}\includegraphics[width=0.3\textwidth]{fig_15a}}
		% CTMN 1
		\subfigure[CTMN]{ \scalebox{0.66}{\begin{tikzpicture}[->,>=stealth',shorten >=0.5pt,auto,node distance=1.92cm,thick,main node/.style={circle,draw,font=\sffamily\Large\bfseries}]
				...
				\end{tikzpicture}}}\\
		% Situation 2
		\subfigure[Sensing area]{\label{fig:cs_toy_scenario_1b}\includegraphics[width=0.3\textwidth]{fig_15c}}%\\
		% CTMN 2
		\subfigure[CTMN]{ \scalebox{0.66}{\begin{tikzpicture}[->,>=stealth',shorten >=0.5pt,auto,node distance=1.92cm,thick,main node/.style={circle,draw,font=\sffamily\Large\bfseries}]
				\tikzstyle{every state}=[fill=white,draw=black,thick,text=black,scale=1]	% Nodes
				\node[main node] (1) [label={right:\small $S_1$ (0.0227)}] {$A$};
				\node[main node] (2) [label={above,right=5mm:\small $S_2$ (0.0114)}] [below of=1] {$A_\text{SR}$};
	...
	Now, let us consider the case where both WLANs apply the SR operation simultaneously. The CTMN for OBSS/PD $\geq$ -79 dBm is illustrated in Fig. \ref{fig:ctmn_toy_scenario_1c}. For the sake of illustration, only transitions between states $s_0$ and $s_1$ are provided. As shown, both WLANs can act by using the default or the SR modes, thus generating a symmetric CTMN. In particular, we find two dominant states: $s_5$  and $s_6$. These states are visited with the same probability (0.4482), which entails that both WLANs alternate the default with the SR mode, thus obtaining the same throughput. However, in reality, one of the WLANs can monopolize the channel through the default mode, so that the other operates under the transmit power-constrained SR mode.
		...
		\begin{figure}[ht!]
		\centering
		\subfigure[CTMN representation]{ \scalebox{0.7}{\begin{tikzpicture}[->,>=stealth',shorten >=0.5pt,auto,node distance=1.92cm,thick,main node/.style={circle,draw,font=\sffamily\Large\bfseries}]
				\tikzstyle{every state}=[fill=white,draw=black,thick,text=black,scale=1]	% Nodes
				\node[main node] (1) [label={right:\small $S_1$ (0.0059)}] {$A$};
				\node[main node] (2) [label={below=-10mm:\small $S_2$ (0.0058)}] [below of=1] {$A_\text{SR}$};
				\node[main node] (3) [label={below=1mm:\small $S_3$ (0.0058)}] [below of=2, below=0mm] {$B_\text{SR}$};
				...
				\node[main node] (6) [label=right:{\small $S_5$ (0.4882)}] [right of=2, right=2mm] {$A_\text{SR}A$};
				\node[main node] (7) [label=right:{\small $S_6$ (0.4882)}] [right of=3, right=2mm] {$AB_\text{SR}$};
				% Arrows
				\path[every node/.style={scale=1.2}]
				...
				\end{tikzpicture}}}
		\subfigure[Throughput]{\label{fig:toy_scenario_1c_results}\includegraphics[width=0.5\columnwidth]{SIM_1_1b}}
	...
	\begin{figure*}[ht!]
		\centering
		\subfigure[Scenario]{\label{fig:toy_scenario_2}\includegraphics[width=0.4\columnwidth]{fig_18}}
		\hspace{1cm}
		\subfigure[Results]{\label{fig:SIM_1_3_individual}\includegraphics[width=0.4\columnwidth]{SIM_1_2}}
...
%	\begin{figure}[ht!]
%		\centering
%		\includegraphics[width=0.4\columnwidth]{SIM_1_2}
...
%	\end{figure}
	...
	\begin{figure}[ht]
		\centering
		\scalebox{0.6}{\begin{tikzpicture}[->,>=stealth',shorten >=0.5pt,auto,node distance=1.92cm,thick,main node/.style={circle,draw,font=\sffamily\Large\bfseries}]
			\tikzstyle{every state}=[fill=white,draw=black,thick,text=black,scale=1]	% Nodes
			...
			\node[main node] (3) [label={below:\small $S_3$ (0.0021)}] [below of=2, above=1.5mm] {$C$};
			\node[main node] (4) [label=left:{\small \begin{tabular}{c}$S_0$ \\(0.0001)\end{tabular}}] [left of=3, below=5mm] {$\emptyset$};
			\node[main node] (5) [label={below:\small $S_4$ (0.0039)}] [below of=3] {$C_{\scaleto{\text{SR}}{4pt}}$};
			...
			\node[main node] (10) [label=right:{\small $S_8$ (0.3266)}] [below of=9, below=1mm] {$A_{\scaleto{\text{SR}}{4pt}}C$};
			\node[main node] (11) [label=right:{\small $S_9$ (0.1643)}] [right of=7, right=15mm] {$B_{\scaleto{\text{SR}}{4pt}}C$};
			% Arrows
			\path[every node/.style={scale=1.2}]
			(1) edge [bend right] node {$\mu_A$} (4)
			(2) edge node {} (4)
	...
	\begin{table}[h]
		...
		\resizebox{0.6\textwidth}{!}{
			\begin{tabular}{c|l|l|}
				...
				\multicolumn{1}{|c|}{} & Path-loss (residential scenario), $\text{PL}(d)$ & See (\citealp{pathloss11ax})  \\ \cline{2-3}
	...
	\begin{figure}[ht!]
		...
		\subfigure[Throughput]{\includegraphics[width=0.4\columnwidth]{SIM_2_2_2}\label{fig:SIM_2_2_2}}
		\subfigure[Traffic load]{\includegraphics[width=0.4\columnwidth]{SIM_2_2_1}\label{fig:SIM_2_2_1}}
	...
	\begin{figure}[ht!]
		\centering		
		\subfigure[WLAN$_A$]{\includegraphics[width=0.48\columnwidth]{SIM_2_3_1}\label{fig:SIM_2_3_1}}
		\subfigure[Others]{\includegraphics[width=0.48\columnwidth]{SIM_2_3_2}\label{fig:SIM_2_3_2}}
	...
	\begin{figure}[ht!]
		...
		\subfigure[Packets exchange]{\includegraphics[width=0.4\columnwidth]{sr_and_tb_b}\label{fig:sr_and_tb_b}}
	...
	\begin{figure}[ht!]
		\centering
		\epsfig{file=fig_25.pdf, width=0.5\columnwidth}
	...
	\begin{figure}[ht!]
		\centering
		\epsfig{file=fig_26.pdf, width=0.5\columnwidth}
